...
export default function BookingsPage({ initialArtists = [], initialSettings = {} }: { initialArtists?: any[], initialSettings?: Record<string,string> }) {
  const pageSettings = useSettings(initialSettings);
  const [selectedArtist, setSelectedArtist] = useState<any | null>(null);
  const { t } = useLanguage();
  const { artists: liveArtists, loading: artistsLoading } = useArtists(initialArtists);
