...
const DEFAULT_SERVICES: Service[] = [
  { id:"1", service_number:"01", title:"Bookings",    tagline:"Connecting Artists & Audiences",             description:"We connect world-class artists with venues, festivals, and private events across the Indian Ocean and beyond.",                                                                         image:toCloudUrl("https://ireyprod.com/wp-content/uploads/2024/02/KDC_2394-scaled.jpg"),         features:["Artist sourcing & negotiation","Contract management","Rider coordination","Travel & logistics"] },
  { id:"2", service_number:"02", title:"Tours",       tagline:"Regional & International Tour Management",   description:"Comprehensive tour management for regional and international tours, handling everything from routing and scheduling to on-the-road support.",                                          image:toCloudUrl("https://ireyprod.com/wp-content/uploads/2024/02/KDC_1597-scaled.jpg"),         features:["Tour routing & scheduling","Venue partnerships","Promotion & marketing","On-tour support"] },
  { id:"3", service_number:"03", title:"Events",      tagline:"End-to-End Event Production",                description:"End-to-end event production from concept to curtain call — we handle every detail so you can focus on the experience.",                                                               image:toCloudUrl("https://ireyprod.com/wp-content/uploads/2024/02/413834455_10229244000198578_5400677520275640617_n.jpg"), features:["Concept development","Venue sourcing","Artist curation","Technical production"] },
